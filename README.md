...
This document is also being converted from using a Pine64 sbc to a Raspberry Pi 4 sbc.
If you are interested in a full setup how-to, please see the setup guide (currently not available) in this repository.

## Docker compose file example
This example uses version 3.x of the compose file format.
Additional settings can be found here: https://docs.docker.com/compose/compose-file
